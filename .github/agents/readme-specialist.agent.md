...
- Maintain a work_log markdown file to track changes of the overall project in short summary form, with links to the specific commits that were made to the README file.
